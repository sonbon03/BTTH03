...
class ArticleController
{
    ...
    public function update()
    {
        ...
        $content = $_POST['content'];
        $article = Article::getById($id);
        $objupdate = new Article($article['id'], $article['title'], $article['content']);
        $objupdate->setTitle($title);
        $objupdate->setContent($content);
        $objupdate->update();
    ...
    public function delete()
    {
        $id = $_GET['id'];
        $article = Article::getById($id);
        $objDelete = new Article($article['id'], $article['title'], $article['content']);
        $objDelete->delete();
